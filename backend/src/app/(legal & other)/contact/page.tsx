              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full p-3 bg-mainWhite text-mainBlack rounded-md border ${errors.email ? "border-red-500" : "border-mainBlack"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full p-3 bg-mainWhite text-mainBlack rounded-md border ${errors.subject ? "border-red-500" : "border-mainBlack"
                      } focus:outline-none focus:ring-2 focus:ring-mainGreen`}
                    required
                  />
                  {errors.subject && (
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className={`w-full p-3 bg-mainWhite text-mainBlack rounded-md border ${errors.message ? "border-red-500" : "border-mainBlack"
                      } focus:outline-none focus:ring-2 focus:ring-mainGreen`}
                    required
                  ></textarea>
                  {errors.message && (
