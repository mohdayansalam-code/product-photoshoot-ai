...
const categoryUsage = [
  { category: "Photoshoots", credits: 45, color: "hsl(217, 91%, 60%)" },
  { category: "AI Tools", credits: 25, color: "hsl(230, 91%, 65%)" },
];
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        >
          <h2 className="font-medium text-foreground text-sm">Credits Used This Week</h2>
